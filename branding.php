<?php include('components/header.php');?>
  ...
  <div class="inner-page">
    <div class="slider-item overlay" style="background-image: url('images/business-branding.jpg');"
  ...
  <div class="section">
    <div class="container">
      <div class="row mb-6">
        <div class="col-lg-7">
          <img src="images/balazs-ketyi-LPWl2pEVGKc-unsplash.jpg" alt="Image" class="img-fluid">
        </div>
        <div class="col-lg-5 ml-auto">
          <h3 class="mb-4"><strong class="d-block text-black">BRANDING</strong></h3>
          <p>Your brand is one of your most valuable assets to make a strategic impression. It's your entire company image going well beyond just your logo. We help you clarify and develop the best way to showcase your business, communicate your story, create a purposefully formulated brand to soar above the rest. </p>
